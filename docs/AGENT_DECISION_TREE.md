...
| :--- | :--- | :--- |
| Implementing New Attack Algorithms | attack-algorithms.md | research-algorithms-pt1.md |
| Phase Progression / Orchestration | phases.md | product-info.md |
| Evaluation / JudgeAgent Scoring | attack-algorithms.md | phases.md |
