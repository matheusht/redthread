...
- [research/stateful-workflow-replay-roadmap.md](research/stateful-workflow-replay-roadmap.md) — Concrete next-phase roadmap for evolving bounded stateful workflow replay into a more assisted, partially-autonomous system. Derived from ATP Tennis Bot test lessons.
